...
import { BookOpen, Search, HelpCircle, Mail, MapPin, Clock, Star, LogOut } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-yellow-50 to-green-100">
      ...
      <div className="bg-green-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
          <div className="flex flex-wrap items-center justify-center space-x-12 text-sm">
            <a href="#presentation" className="hover:text-yellow-200 transition-colors">
              Présentation
            </a>
            <Button
            ...
            <Button
              onClick={() => router.push("/student/emprunt")}
              className="hover:text-yellow-200 transition-colors flex items-center space-x-1"
            >
              <span>Emprunt</span>
            </Button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <Select>
                    <SelectTrigger className="border-yellow-200">
                      <SelectValue placeholder="Recherche par titre" />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="titre">Par titre</SelectItem>
                  ...
                  <Select>
                    <SelectTrigger className="border-yellow-200">
                      <SelectValue placeholder="Recherche par auteur" />
                    </SelectTrigger>
                    <SelectContent>
                  ...
                  <Select>
                    <SelectTrigger className="border-yellow-200">
                      <SelectValue placeholder="Genre/Spécialisation" />
                    </SelectTrigger>
                    <SelectContent>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Section "Entrez dans la bibliothèque" avec l'image */}
